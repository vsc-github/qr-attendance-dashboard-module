...
class Navbar extends Component {
    render() {
        ...
        <div className="navbar-brand">
          <a className="navbar-item" href="/" style={{ paddingBottom: 0 }}>
            <img src="https://www.mhprep.com/uploads/4/3/9/7/4397552/published/attendance-matters.png?1500339894" style={{ maxHeight: 'initial', maxWidth: '8rem' }} />
          </a>
